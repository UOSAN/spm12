...
% values are the same as those used at the LCNI (KD 7/15/16)
%
% FORMAT pm_defaults
%
...
pm_def.K_SPACE_TRAVERSAL_BLIP_DIR = 1; % +ve k-space = 1, -ve k-space = -1
pm_def.TOTAL_EPI_READOUT_TIME = 33.5;   % Skyra EPI RO time, Total Readout Time (SPM) = 1/(BandwidthPerPixelPhaseEncode)
                                           % 1 / 26.893 = 0.03718439743 seconds = 37.18 ms
